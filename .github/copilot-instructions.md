...
Folder for managing components

pages

Defines each page; managed as one directory per page

hooks

Folder for managing custom hooks

utils

General utility functions (non-hook)

services

Logic related to API requests
...
Global state management definitions

routes

Route definitions (managed flatly)
