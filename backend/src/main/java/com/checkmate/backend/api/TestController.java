...
public class TestController {
  ...
  @Operation(summary = "테스트 API (용범)", description = "여기는 description 입니다.")
  @ApiResponses({
    ...
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "4XX",
        description = "예외 메시지입니다!"),
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "500",
        description = "여기도 예외 메시지입니다!"),
  })
  @GetMapping
  ...
  @Operation(summary = "400 응답 테스트 API (용범)", description = "여기는 description 입니다.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
        description = "테스트 응답 성공"),
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "400",
        description = "요청 값이 입력되지 않았습니다.")
  })
  @GetMapping("/400")
  ...
  @Operation(summary = "404 응답 테스트 API (용범)", description = "여기는 description 입니다.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
        description = "테스트 응답 성공"),
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "404",
        description = "해당 결제 정보를 찾을 수 없습니다.")
  })
  @GetMapping("/404")
  ...
  @Operation(summary = "500 응답 테스트 API (용범)", description = "여기는 description 입니다.")
  @ApiResponses({
    @io.swagger.v3.oas.annotations.responses.ApiResponse(
        responseCode = "200",
        description = "테스트 응답 성공"),
