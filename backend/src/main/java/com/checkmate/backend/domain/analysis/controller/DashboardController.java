...
public class DashboardController {
                    ...
                    content = @Content(
                            ...
                            examples = {
                                    @ExampleObject(
                                            name = "개수 초과",
                                            summary = "최대 개수 제한",
                                            value = "{ \"success\": false, \"message\": \"대시보드는 최대 5개까지 생성 가능합니다.\", \"errorCode\": \"DASHBOARD_LIMIT_EXCEEDED\" }"),
                                    @ExampleObject(
                                            name = "이름 형식 오류",
                                            summary = "유효하지 않은 이름",
                                            value = "{ \"success\": false, \"message\": \"유효하지 않은 대시보드 이름입니다.\", \"errorCode\": \"INVALID_DASHBOARD_NAME\" }"),
                                    @ExampleObject(
                                            name = "글자 수 초과",
                                            summary = "6자 제한 위반",
                                            value = "{ \"success\": false, \"message\": \"대시보드 이름은 최대 6자까지 입력 가능합니다.\", \"errorCode\": \"DASHBOARD_NAME_TOO_LONG\" }"),
                                    @ExampleObject(
                                            name = "이름 중복",
                                            summary = "중복된 이름 존재",
                                            value = "{ \"success\": false, \"message\": \"이미 존재하는 대시보드 이름입니다.\", \"errorCode\": \"DUPLICATE_DASHBOARD_NAME\" }")
                            }
                    ))
    })
    @PostMapping
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    name = "성공 응답 예시",
                                    value = "{ \"success\": true, \"message\": \"대시보드 수정에 성공했습니다.\" }"
                            )
                    )),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "400",
                    ...
                    content = @Content(
                            ...
                            examples = {
                                    @ExampleObject(
                                            ...
                                            value = "{ \"success\": false, \"message\": \"기본 대시보드는 수정할 수 없습니다.\", \"errorCode\": \"DEFAULT_DASHBOARD_MODIFICATION_RESTRICTED\" }"),
                                    @ExampleObject(
                                            name = "이름 형식 오류",
                                            summary = "유효하지 않은 이름",
                                            value = "{ \"success\": false, \"message\": \"유효하지 않은 대시보드 이름입니다.\", \"errorCode\": \"INVALID_DASHBOARD_NAME\" }"),
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    ...
                                    value = "{ \"success\": false, \"message\": \"해당 대시보드에 접근할 권한이 없습니다.\", \"errorCode\": \"DASHBOARD_ACCESS_DENIED\" }"
                            )
                    ))
    })
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    name = "성공 응답 예시",
                                    value = "{ \"success\": true, \"message\": \"대시보드 삭제에 성공했습니다.\" }"
                            )
                    )),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "400",
    ...
    @Operation(summary = "대시보드 레이아웃 편집 및 저장 API (한울)", description = "특정 대시보드 내의 지표 카드 배치를 저장합니다. (홈 대시보드 수정 불가)")
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "200",
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    name = "성공 응답 예시",
                                    value = "{ \"success\": true, \"message\": \"대시보드 레이아웃 저장에 성공했습니다.\", \"data\": 1 }"
                            )
                    )),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "400",
                    ...
                    content = @Content(
                            ...
                            examples = {
                                    ...
                                    @ExampleObject(
                                            ...
                                            value = "{ \"success\": false, \"message\": \"유효하지 않은 카드 타입입니다.\", \"errorCode\": \"INVALID_CARD_TYPE\" }"),
                                    @ExampleObject(
                                            name = "카드 타입 중복",
                                            summary = "중복된 카드 타입 존재",
                                            value = "{ \"success\": false, \"message\": \"중복된 카드 타입이 존재합니다.\", \"errorCode\": \"DUPLICATE_CARD_TYPE\" }"),
                                    @ExampleObject(
                                            name = "위치 형식 오류",
                                            summary = "유효하지 않은 카드 위치",
                                            value = "{ \"success\": false, \"message\": \"유효하지 않은 카드 위치입니다.\", \"errorCode\": \"INVALID_DASHBOARD_CARD_POSITION\" }"),
                                    @ExampleObject(
                                            name = "위치 중복",
                                            summary = "카드 위치 겹침",
                                            value = "{ \"success\": false, \"message\": \"카드 위치가 겹칩니다.\", \"errorCode\": \"DUPLICATE_CARD_POSITION\" }")
                            }
                    )),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "403",
            ...
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    ...
                                    value = "{ \"success\": false, \"message\": \"대시보드를 찾을 수 없습니다.\", \"errorCode\": \"DASHBOARD_NOT_FOUND\" }"
                            )
                    ))
    })
    ...
    @ApiResponses({
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    name = "성공 응답 예시",
                                    value = "{ \"success\": true, \"message\": \"대시보드 레이아웃 조회에 성공했습니다.\", \"data\": [ { \"cardCode\": \"WTH_01_01\", \"rowNo\": 1, \"colNo\": 1 }, { \"cardCode\": \"WTH_02_01\", \"rowNo\": 1, \"colNo\": 2 } ] }"
                            )
                    )),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(
                    responseCode = "403",
