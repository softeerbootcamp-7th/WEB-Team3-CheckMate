...
@Slf4j
public class TodaySalesByOrderChannelProcessor implements AnalysisProcessor<SalesAnalysisContext> {
    ...
    public AnalysisResponse process(SalesAnalysisContext context) {
        ...
        DashboardTodaySalesByOrderChannelResponse dashboardResponse =
                new DashboardTodaySalesByOrderChannelResponse(insight, items);

        DetailTodaySalesByOrderChannelResponse detailResponse =
                new DetailTodaySalesByOrderChannelResponse(items);
