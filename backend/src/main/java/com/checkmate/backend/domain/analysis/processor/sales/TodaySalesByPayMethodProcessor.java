...
import com.checkmate.backend.domain.analysis.dto.response.sales.DashboardTodaySalesByPayMethodResponse;
import com.checkmate.backend.domain.analysis.dto.response.sales.DetailTodaySalesByPayMethodResponse;
...
@Slf4j
public class TodaySalesByPayMethodProcessor implements AnalysisProcessor<SalesAnalysisContext> {
    private final SalesAnalysisRepository salesAnalysisRepository;

    @Override
    public boolean supports(AnalysisCardCode analysisCardCode) {
        return AnalysisCardCode.SLS_08_01 == analysisCardCode;
    }
    ...
    public AnalysisResponse process(SalesAnalysisContext context) {
        ...
        DashboardTodaySalesByPayMethodResponse dashboardResponse =
                new DashboardTodaySalesByPayMethodResponse(insight, items);

        DetailTodaySalesByPayMethodResponse detailResponse =
                new DetailTodaySalesByPayMethodResponse(items);
