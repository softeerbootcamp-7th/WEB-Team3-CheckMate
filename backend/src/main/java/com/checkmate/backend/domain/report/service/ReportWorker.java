...
public class ReportWorker {
    ...
    private static final String PROMPT_TEMPLATE =
            ...
            내일 컨텍스트(있을 때만 사용):
            - tomorrowContext(optional): { dayOfWeek?: string, weather?: string, event?: string, holiday?: boolean, notes?: string }
    ...
    public void processTask() {
        ...
        try {
            ...
            String llmResponse = llmClient.ask(PROMPT_TEMPLATE, buildPrompt(data));
    ...
    protected void saveReportResult(ReportTask task, String llmResponse)
        ...
        Report report =
                Report.builder()
                        ...
                        .statusLabel(root.path("status_label").asText())
                        .netSalesSummary(kpi.path("net_sales").asText())
