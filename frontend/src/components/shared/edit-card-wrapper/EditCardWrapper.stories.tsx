...
const SampleChild = () => {
  return (
    <div className="flex w-75 flex-col gap-1.5">
...
export const WideChildeComponent: Story = {
  args: {
    ...
    period: '오늘',
    children: (
      <div className="flex h-[200px] w-265 flex-col gap-2 bg-amber-300">
        <div className="title-large-semibold break-keep">
          가로가 긴 자식 콘텐츠
        </div>
...
export const TallChildComponent: Story = {
  args: {
    ...
    period: '오늘',
    children: (
      <div className="flex h-[800px] w-75 flex-col gap-2 bg-amber-300">
        <div className="title-large-semibold break-keep">
          세로가 긴 자식 콘텐츠
        </div>
        <span className="body-small-medium break-keep text-gray-600">
